...
export default async function AdminQuestionsPage() {
  ...
  const { data: predictions } = await supabase
    .from("predictions")
    .select("id, title, description, status, resolution, yes_pool, no_pool, participant_count, ends_at, created_at, is_featured, is_trending, image_url, image_position, category_id, profiles(username)")
